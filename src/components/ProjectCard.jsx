...
function ProjectCards() {
    const Projects = [
        ...
        },
        {
            ...
            npm: 'https://www.npmjs.com/package/editorjs-image-crop-resize'
        },
        {
            id: 4,
                    ...
                    <div className="md:w-3/5">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-1.5 ">
                                ...
                                {project.npm &&
                                    <button className="bg-none flex items-center cursor-pointer hover:underline"
                                        onClick={() => window.open(project.npm, '_blank')}
                                    >
                                        <img src="/npm-2.svg" alt="npm" className="w-[16px] h-[16px] mr-0.5" />
                                        <span className="text-gray-800 text-[18px]">npmjs</span>
                                    </button>
                                }
